        ...
        <html lang="en">
            ...
            <body>
                  <div>
                      ...
                      <div class="fundpitch">
                          You have been invited to join FundPitch to check the pitch of ${companyName} by ${name}
                          </div>               
                          <div class="">
...
const inviteEmail = async ({
  ...
  try {
    // Run database operation and email sending in parallel
    const [dbResult] = await Promise.all([
      ...
      emailTransport.sendMail({
        ...
        to: email,
        subject: "FUND PITCH TEAM INVITATION",
