...
import NotFound from "../../company-view/_components/not-found";
import { RoleChangeRequests } from "../../_components/rolechange-card";
  ...
  return (
    <div className="mx-auto h-full w-full bg-gray-100">
      <div className="flex flex-col gap-4 px-4 md:flex-row">
        <Card className="flex w-[60%] flex-row items-center gap-8 rounded-lg bg-white p-8 shadow-lg">
        ...
        <Card className="flex w-[40%] flex-row items-center gap-8 rounded-lg bg-white p-8 shadow-lg">
          <RoleChangeRequests />
        </Card>
      </div>
